...
export const reportService = {
  ...
  async sendDailyReport(dateStr: string, emailTo?: string) {
    ...
    const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://dashboard-bvl-next.vercel.app';
    const publicOverviewUrl = `https://dashboard-bvl-next.vercel.app/public/overview`;
                ...
                <tr>
                  <td style="padding: 30px 40px;">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin: 25px 0; background: #0f172a; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
                      <tr>
                        <td style="padding: 22px 24px; text-align: center; background: #0f172a;">
                          <p style="margin: 0 0 4px 0; font-size: 10px; font-weight: 800; color: #f59e0b; text-transform: uppercase; letter-spacing: 1.5px;">LIVE DASHBOARD</p>
                          <h2 style="margin: 0 0 6px 0; font-size: 18px; font-weight: 800; color: #ffffff; letter-spacing: -0.3px;">Monthly Overview</h2>
                          <p style="margin: 0 0 16px 0; font-size: 12px; color: #94a3b8;">Lihat laporan lengkap pergerakan penjualan dan tren butik</p>
